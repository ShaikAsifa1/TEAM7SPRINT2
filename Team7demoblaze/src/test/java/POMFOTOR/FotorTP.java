...
public class FotorTP {
    ...
    objHome = new FotorHP(driver);
    objHome.clickSignIn();
    
    objLogin = new FotorLP(driver);
    objAcc = new FotorAP(driver);
    FileInputStream fis = new FileInputStream("C:\\Users\\shivr\\OneDrive\\Desktop\\selenium\\Data source\\Fotorcredentials.xlsx");
    XSSFWorkbook workbook = new XSSFWorkbook(fis);
		...
		for(int i = 0; i <= rownum ; i++) {
			...
			objLogin.loginToAP(email.toString(),password.toString());
			Thread.sleep(3000);
